...
Status in this repo:
- `collatz_conjecture` is a formalized theorem target, not a completed proof.
- the file demonstrates theorem representation and sealing flow; it does not resolve the full conjecture.
...
▶ Sealing proofs to WORM ledger: examples/collatz.axiom
  ✓ Sealed theorem target 'collatz_conjecture' (example output)
  ✓ Sealed theorem 'collatz_1' (example output)
  ✓ Sealed theorem 'collatz_2' (example output)
